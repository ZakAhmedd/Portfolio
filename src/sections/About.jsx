...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('zakattackgamer@gmail.com')
  ...
  return (
    <section className="c-space my-20" id="about">
        <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
            ...
            <div className="col-span-1 xl:row-span-3">
                <div className="grid-container">
                    <img src="/assets/grid2new.png" alt="grid-2" className="w-full sm:w-[276px] h-fit object-contain" />
            ...
            <div className="col-span-1 xl:row-span-4">
                <div className="grid-container">
                    ...
                    <div>
                        ...
                        <p className="grid-subtext">
                            I'm based in the UK, with remote work available.
                        </p>
                        <Button name="United Kingdom" isBeam containerClass="w-full mt-10"/>
            ...
            <div className="xl:col-span-1 xl:row-span-2">
                <div className="grid-container">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">zakattackgamer@gmail.com</p>
                        </div>
                    </div>
                </div>
